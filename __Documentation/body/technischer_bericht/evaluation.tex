...
\begin{figure}[H]
	...
	\caption{React Native Map Implementation\cite{react-native-map}}
...
Wir möchten mit unserer App \brand{OpenStreetMap} Daten verbessern und möchten somit aus moralischen Aspekten auch auf diese Karte setzen. 
Allein schon die Lizenz von \brand{Google} erlaubt es uns nicht, eigene Marker und andere Elemente auf ihren Kacheln darzustellen. 
