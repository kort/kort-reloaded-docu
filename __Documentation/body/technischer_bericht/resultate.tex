...
%Unterpunkte Android(fehlende Kartenansicht) - iOS (nicht getestet)
%Badges fehlen (Validation)
%Design nicht umgesetzt


\begin{itemize}
	\item \brand{Android}-App mit gleicher Funktionalität, wie die \gls{WebApp}
