...
Erreichte Ziele:
\begin{itemize}
	\item Eine \brand{Android}-App mit gleicher Grundfunktionalität, wie die \gls{WebApp}.
	\item Eine \brand{iOS}-App mit gleicher Grundfunktionalität, wie die \gls{WebApp}.
	\begin{itemize}
		\item Nicht getestet
	\end{itemize}
