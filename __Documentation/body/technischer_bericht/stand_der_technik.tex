...
Im Gegensatz zu den anderen Social-Login-Varianten (\brand{Google} und \brand{Facebook}), die OAuth 2.0 anbieten, unterstützt \brand{OpenStreetMap} noch OAuth 1.0a.
