...
Aus diesem Grund entstand die Idee, die \kort{}-\gls{WebApp} durch einen native Client zu ersetzen.
...
Dadurch, dass \brand{React Native} noch in den Kinderschuhen steckt und die Entwickler, Marino Melchiori und Dominic Mülhaupt, noch keine Erfahrung mit \brand{JavaScript} haben, stellt dies ein grosses \hyperref[pm-projektmanagement-risikomanagement]{Risiko} für diese Bachelorarbeit dar.
...
Es entstand die Idee, den Validierungsmechanismus von \kort{} abzulösen.
...
Validierungsaufträge werden dem Benutzer nun einfach als normale Aufträge angezeigt.
...
\begin{itemize}
	...
	\item Der Validierungsmechanismus soll abgelöst werden.
