...
Das \brand{OpenStreetMap}-Projekt beinhaltet eine sehr grosse Menge an Geodaten, welche frei zugänglich sind.
...
Die \brand{OpenStreetMap}-Community forderte aber, dass die Antworten geprüft werden müssen.
...
Ab drei positiven Bewertungen gilt die Antwort als korrekt und sie schafft es in die \brand{OpenStreetMap}-Datenbank.
