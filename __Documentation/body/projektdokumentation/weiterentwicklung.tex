...
\begin{itemize}
	...
	\item Und wie kann der Benutzer mithilfe von Konzepten der Gamification weiter motiviert werden, zur Datenpflegung beizutragen?
\end{itemize}
...
\begin{itemize}
	...
	\item Layout und Design
	\item Tab-Icons für \brand{iOS}
\end{itemize}
...
Die zweite Highscore-Ansicht zeigt den eingeloggten Benutzer mit seinen direkten Konkurrenten vor und nach ihm. 
Wenn sich der Benutzer in der Ansicht zum Lösen einer Mission befindet, gäbe es in einem weiteren Tab eine Karte, die das Objekt der Mission markiert hervorgehoben anzeigt. 
