...
\begin{itemize}
	...
	\begin{itemize}
		\item Wie die Google Client ID erhalten wird, ist in der Anleitung vom \brand{GitHub}-Projekt der Google-Signin-Library erklärt.\footnote{\url{https://www.mapbox.com/help/create-api-access-token/}}
