...
Wenn die \brand{JavaScript}-Seite der Bridge initialisiert ist, kann sie darauf zugreifen. 
...
% immer mehr Apps im Showcase, das führt zu neuen Pull-requests und Beiträgen, reload