...
Viele Informationen sind in den Issues (aktuell sind 733 offene Issues vorhanden) vom \brand{React Native} GitHub-Repository\footnote{\url{https://github.com/facebook/react-native/issues}}  versteckt.
