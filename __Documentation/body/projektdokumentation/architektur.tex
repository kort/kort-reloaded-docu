...
Das Pattern beschreibt folgende vier Hauptbestandteile: die Stores, die Views (oder Controller-Views), die Actions und den Dispatcher.
\begin{figure}[H]
 	\centering
...
Sie unterscheiden sich aber insofern, dass sie nicht unbedingt einzelne Model-Klassen repräsentieren sollen, sondern domänenspezifische Aufgaben übernehmen.
