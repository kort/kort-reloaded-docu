...
\begin{itemize}
	...
	\end{itemize}
	\item \brand{Travis-CI} Konfoguration aktualisieren
\end{itemize}
...
\kort{} erfolgreich auf \brand{iOS} getestet werden.

Für die geplante Studienarbeit wurde evaluiert, ob \kort{} als \brand{React}-\gls{WebApp} umgesetzt werden könnte. 
