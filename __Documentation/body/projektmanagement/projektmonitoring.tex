...
In der \textit{Kort Projekt}-Kategorie ging es vor allem um die Implementation der Architektur und die Verwendung von \brand{React Native}. 
Die Kategorien \textit{Login}, \textit{Missionen}, \textit{Profil} und \textit{Highscore} enthalten die Implementation der \gls{GUI}. 
\textit{Map} und \textit{Internationalisierung} sind Kategorien, bei denen es um die Einrichtung der entsprechend verwendeten \glslink{Library}{Libraries} ging. 
...
Der zu hoch geschätzte Aufwand im Bereich \textit{Gamification und Design} entstand, weil noch nicht alle Tickets abgeschlossen sind.
...
\hline
Dokumentation & 124.00 & 118.25 h & -5.75 h \\
\hline
