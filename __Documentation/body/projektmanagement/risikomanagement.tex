...
\textbf{R01 Mangelnde Erfahrung mit \brand{JavaScript}, \brand{React} und \brand{React Native}}: Die Eintrittswahrscheinlichkeit konnte auf 50\% gesenkt werden. \textbf{R03} wurde nach Absprache mit Jürg Hunziker und Stefan Oderbolz ganz eliminiert.
...
Das Eintreten von \textbf{R02 Es existiert keine passende Map Library für \brand{React Native}} konnte weiterhin auf 10\% gesenkt werden. Die Marker waren Klickbar und sie enthielten alle nötigen Informationen für das Lösen einer Mission.
...
\textbf{R06: Mangelnde Erfahrung mit OAuth} ist ein weiterhin bestehendes Risiko - die \brand{OpenStreetMap}-Authentifizierung konnte leider nicht umgesetzt werden.