...
\hline
\textbf{Vorbeugung} & Die mangelnden Funktionalitäten (wie zum Beispiel im Testing) werden bereits bevor mit der Implementation begonnen wird, so weit möglich, analysiert.
...
\textbf{R06: Mangelnde Erfahrung mit \gls{OAuth}}: Dies ist ein weiterhin bestehendes Risiko - die \brand{OpenStreetMap}-Authentifizierung konnte leider nicht umgesetzt werden.