...
\newglossaryentry{GUI}{
	name = GUI,
	description = {GUI ist eine Abkürzung für graphical user interface und bedeutet Grafische  Benutzeroberfläche.\cite{gui}}
}
...
\newglossaryentry{IDE}{
	name = IDE,
	description = {IDE bedeutet Integrierte Entwicklungsumgebung (von englisch integrated development environment)\cite{ide}.}
}